...
public interface V2Api {
    ...
    @Operation(summary = "get the catalog of services that the service broker offers", description = "", tags={ "Catalog" })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Catalog> catalogGetUsingGET(@Parameter(in = ParameterIn.HEADER, description = "version number of the Service Broker API that the Platform will use" ,required=true,schema=@Schema()) @RequestHeader(value="X-Broker-API-Version", required=true) String xBrokerAPIVersion);


    @Operation(summary = "generate a service binding", description = "", tags={ "ServiceBindings" })
    @ApiResponses(value = { 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "Not Found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorModelNamenamespaceioSwaggerModelNameError.class))) })
    @RequestMapping(value = "/v2/service_instances/{instance_id}/service_bindings/{binding_id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ...
    @Operation(summary = "get the last requested operation state for service binding", description = "", tags={ "ServiceBindings" })
    @ApiResponses(value = { 
    ...
    @Operation(summary = "get the last requested operation state for service instance", description = "", tags={ "ServiceInstances" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = LastOperationResource.class))),
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "202", description = "Accepted", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorModelNamenamespaceioSwaggerModelNameServiceInstanceAsyncOperation.class))),
    ...
    @Operation(summary = "update a service instance", description = "", tags={ "ServiceInstances" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Object.class))),
